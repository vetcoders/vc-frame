...
* fix(compact-bar): wheel events over the one-row chrome follow the focused terminal pane instead of switching tabs, preserving native mouse scrolling in TUIs, alternate-screen fallback and ordinary scrollback behavior
