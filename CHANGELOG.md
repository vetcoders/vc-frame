...
## [Unreleased]
* fix(install): on Unix, stage, sign, sync, and atomically publish vc-frame updates so running servers keep their original executable inode; Windows retains the existing non-atomic copy fallback
