...
use crate::data::{
    ...
    NewPanePlacement, OriginatingPlugin, PaneId, PluginTag, Resize, TabPlacement, WebSharing,
};
...
fn test_client_messages() {
    ...
    test_client_roundtrip!(ClientToServerMsg::FirstClientConnected {
        cli_assets: CliAssets {
            ...
            configuration_options: Some(Options {
                ...
                auto_lock_after_seconds: Some(15),
    ...
    test_client_roundtrip!(ClientToServerMsg::Action {
        action: Action::DumpScreen {
            ...
            ansi: false,
            expected_tab_id: Some(7),
            expected_tab_name: Some("work-123".to_owned()),
    ...
    test_client_roundtrip!(ClientToServerMsg::Action {
        action: Action::CloseTabByIdIfNameIfQuiescent {
            id: 7,
            expected_name: "work-123".to_owned(),
            expected_session_incarnation: "server-abc".to_owned(),
            expected_tab_instance_id: "11111111111111111111111111111111".to_owned(),
